...
urlpatterns = patterns(
    ...
    url(r'^accounts/login/$', login,
        {'template_name': 'enhydris/registration/login.html'}, 'login'),
    url(r'^accounts/', include('registration.backends.default.urls')),
    url(r'^accounts/password/reset/$', password_reset,
        {'template_name': 'enhydris/registration/password_reset.html'},
        'password_reset'),
    url(r'^accounts/password/reset/done/$', password_reset_done,
        {'template_name': 'enhydris/registration/password_reset_done.html'},
        'password_reset_done'),
    url(r'^accounts/password/change/$', password_change,
        {'template_name': 'enhydris/registration/password_change.html'},
        'password_change'),
    url(r'^accounts/password/change/done/$', password_change_done,
        {'template_name': 'enhydris/registration/password_change_done.html'},
