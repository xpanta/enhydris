...
globals [total-water-demand Volatility_SocialImpact end-pricingpolicy Environmental_Awareness_Campaign price_change_info results1 r1 results2 r2]
...
; Setup the household's characteristics
  ...
  ifelse conserv-dummy >= Z [set water-demand (1 - conservation-rate) * water-demand][set water-demand mean-water-demand]]
...
to calc-water-demand
  if ticks mod 12 = 0 [set mean-water-demand round (mean-water-demand * (1 + water-demand-increase-rate))]
ask turtles with [opinion-watercons = -1] [set water-demand mean-water-demand]
ask turtles with [opinion-watercons = 1][
  set Z random-float 1
  ifelse conserv-dummy >= Z [set water-demand (1 - conservation-rate) * water-demand][set water-demand mean-water-demand]]
