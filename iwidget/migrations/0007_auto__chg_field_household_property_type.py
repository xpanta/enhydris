...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Household.property_type'
        db.alter_column('iwidget_household', 'property_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.PropertyType'], null=True))

    def backwards(self, orm):

        # Changing field 'Household.property_type'
        db.alter_column('iwidget_household', 'property_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['iwidget.PropertyType']))
    ...
    models = {
        ...
        'iwidget.household': {
            ...
            'property_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.PropertyType']", 'null': 'True'}),
