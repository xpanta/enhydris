...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('iwidget_propertytype', (
        ...
        db.send_create_signal('iwidget', ['PropertyType'])

        # Adding model 'DMA'
        db.create_table('iwidget_dma', (
        ...
        db.send_create_signal('iwidget', ['DMA'])

        # Adding model 'Household'
        db.create_table('iwidget_household', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='household', to=orm['auth.User'])),
            ('property_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.PropertyType'])),
            ('dma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.DMA'])),
        ))
        db.send_create_signal('iwidget', ['Household'])

        # Adding model 'IWTimeseries'
        db.create_table('iwidget_iwtimeseries', (
            ('timeseries_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hcore.Timeseries'], unique=True, primary_key=True)),
            ('typical', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('iwidget', ['IWTimeseries'])


    def backwards(self, orm):
        # Deleting model 'PropertyType'
        db.delete_table('iwidget_propertytype')

        # Deleting model 'DMA'
        db.delete_table('iwidget_dma')

        # Deleting model 'Household'
        db.delete_table('iwidget_household')

        # Deleting model 'IWTimeseries'
        db.delete_table('iwidget_iwtimeseries')
    ...
    models = {
        ...
        'iwidget.household': {
            ...
            'dma': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.DMA']"}),
            'gpoint_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hcore.Gpoint']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'household'", 'to': "orm['auth.User']"})
        },
