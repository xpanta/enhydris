...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Household.property_size'
        db.add_column('iwidget_household', 'property_size',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Household.property_size'
        db.delete_column('iwidget_household', 'property_size')
