...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('iwidget_householdvaluesubcategory', (
            ...
            ('form_component', self.gf('django.db.models.fields.CharField')(max_length=45)),
        ))
        db.send_create_signal('iwidget', ['HouseholdValueSubcategory'])

        # Adding model 'HouseholdValueCategory'
        db.create_table('iwidget_householdvaluecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['HouseholdValueCategory'])

        # Adding model 'ArithmeticValueItem'
        db.create_table('iwidget_arithmeticvalueitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('iwidget', ['ArithmeticValueItem'])

        # Adding unique constraint on 'ArithmeticValueItem', fields ['subcategory', 'household']
        db.create_unique('iwidget_arithmeticvalueitem', ['subcategory_id', 'household_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArithmeticValueItem', fields ['subcategory', 'household']
        db.delete_unique('iwidget_arithmeticvalueitem', ['subcategory_id', 'household_id'])

        # Deleting model 'HouseholdValueSubcategory'
        db.delete_table('iwidget_householdvaluesubcategory')

        # Deleting model 'HouseholdValueCategory'
        db.delete_table('iwidget_householdvaluecategory')

        # Deleting model 'ArithmeticValueItem'
        db.delete_table('iwidget_arithmeticvalueitem')
    ...
    models = {
        ...
        'iwidget.householdvaluesubcategory': {
            ...
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'form_component': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'original_db': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dbsync.Database']", 'null': 'True'}),
            'original_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
