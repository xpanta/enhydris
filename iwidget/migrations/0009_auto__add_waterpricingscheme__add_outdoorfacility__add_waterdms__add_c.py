...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('iwidget_waterpricingscheme', (
        ...
        db.send_create_signal('iwidget', ['WaterPricingScheme'])

        # Adding model 'OutdoorFacility'
        db.create_table('iwidget_outdoorfacility', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['OutdoorFacility'])

        # Adding model 'WaterDMS'
        db.create_table('iwidget_waterdms', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['WaterDMS'])

        # Adding model 'ConstructionPeriod'
        db.create_table('iwidget_constructionperiod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['ConstructionPeriod'])

        # Adding model 'OwnershipStatus'
        db.create_table('iwidget_ownershipstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['OwnershipStatus'])

        # Adding model 'WaterHeater'
        db.create_table('iwidget_waterheater', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['WaterHeater'])

        # Adding model 'EfficientAppliance'
        db.create_table('iwidget_efficientappliance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('original_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('original_db', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbsync.Database'], null=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ...
        db.send_create_signal('iwidget', ['EfficientAppliance'])

        # Adding field 'Household.construction_period'
        db.add_column('iwidget_household', 'construction_period',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.ConstructionPeriod'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Household.ownership_status'
        db.add_column('iwidget_household', 'ownership_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.OwnershipStatus'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Household.water_pricing'
        db.add_column('iwidget_household', 'water_pricing',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['iwidget.WaterPricingScheme'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field outdoor_facilities on 'Household'
        m2m_table_name = db.shorten_name('iwidget_household_outdoor_facilities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('household', models.ForeignKey(orm['iwidget.household'], null=False)),
            ('outdoorfacility', models.ForeignKey(orm['iwidget.outdoorfacility'], null=False))
        ))
        db.create_unique(m2m_table_name, ['household_id', 'outdoorfacility_id'])

        # Adding M2M table for field water_heaters on 'Household'
        m2m_table_name = db.shorten_name('iwidget_household_water_heaters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('household', models.ForeignKey(orm['iwidget.household'], null=False)),
            ('waterheater', models.ForeignKey(orm['iwidget.waterheater'], null=False))
        ))
        db.create_unique(m2m_table_name, ['household_id', 'waterheater_id'])

        # Adding M2M table for field efficient_appliances on 'Household'
        m2m_table_name = db.shorten_name('iwidget_household_efficient_appliances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('household', models.ForeignKey(orm['iwidget.household'], null=False)),
            ('efficientappliance', models.ForeignKey(orm['iwidget.efficientappliance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['household_id', 'efficientappliance_id'])

        # Adding M2M table for field water_dms on 'Household'
        m2m_table_name = db.shorten_name('iwidget_household_water_dms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('household', models.ForeignKey(orm['iwidget.household'], null=False)),
            ('waterdms', models.ForeignKey(orm['iwidget.waterdms'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('iwidget_waterpricingscheme')

        # Deleting model 'OutdoorFacility'
        db.delete_table('iwidget_outdoorfacility')

        # Deleting model 'WaterDMS'
        db.delete_table('iwidget_waterdms')

        # Deleting model 'ConstructionPeriod'
        db.delete_table('iwidget_constructionperiod')

        # Deleting model 'OwnershipStatus'
        db.delete_table('iwidget_ownershipstatus')

        # Deleting model 'WaterHeater'
        db.delete_table('iwidget_waterheater')

        # Deleting model 'EfficientAppliance'
        db.delete_table('iwidget_efficientappliance')

        # Deleting field 'Household.construction_period'
        db.delete_column('iwidget_household', 'construction_period_id')

        # Deleting field 'Household.ownership_status'
        db.delete_column('iwidget_household', 'ownership_status_id')

        # Deleting field 'Household.water_pricing'
        db.delete_column('iwidget_household', 'water_pricing_id')

        # Removing M2M table for field outdoor_facilities on 'Household'
        db.delete_table(db.shorten_name('iwidget_household_outdoor_facilities'))

        # Removing M2M table for field water_heaters on 'Household'
        db.delete_table(db.shorten_name('iwidget_household_water_heaters'))

        # Removing M2M table for field efficient_appliances on 'Household'
        db.delete_table(db.shorten_name('iwidget_household_efficient_appliances'))

        # Removing M2M table for field water_dms on 'Household'
        db.delete_table(db.shorten_name('iwidget_household_water_dms'))
    ...
    models = {
        ...
        'iwidget.constructionperiod': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'ConstructionPeriod'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.efficientappliance': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'EfficientAppliance'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.household': {
            ...
            'construction_period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.ConstructionPeriod']", 'null': 'True', 'blank': 'True'}),
            'dma': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'households'", 'to': "orm['iwidget.DMA']"}),
            'efficient_appliances': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['iwidget.EfficientAppliance']", 'symmetrical': 'False'}),
            'gpoint_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hcore.Gpoint']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'outdoor_facilities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['iwidget.OutdoorFacility']", 'symmetrical': 'False'}),
            'ownership_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.OwnershipStatus']", 'null': 'True', 'blank': 'True'}),
            'property_size': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'property_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.PropertyType']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'households'", 'to': "orm['auth.User']"}),
            'water_dms': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['iwidget.WaterDMS']", 'symmetrical': 'False'}),
            'water_heaters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['iwidget.WaterHeater']", 'symmetrical': 'False'}),
            'water_pricing': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['iwidget.WaterPricingScheme']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'iwidget.outdoorfacility': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'OutdoorFacility'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.ownershipstatus': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'OwnershipStatus'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.waterdms': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'WaterDMS'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.waterheater': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'WaterHeater'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'iwidget.waterpricingscheme': {
            'Meta': {'ordering': "('descr',)", 'object_name': 'WaterPricingScheme'},
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
