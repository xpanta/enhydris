...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('iwidget_appliancetimeseries', (
        ...
        db.send_create_signal('iwidget', ['ApplianceTimeseries'])

        # Adding model 'SmartMeter'
        db.create_table('iwidget_smartmeter', (
            ('instrument_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hcore.Instrument'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('iwidget', ['SmartMeter'])

        # Adding model 'Appliance'
        db.create_table('iwidget_appliance', (
        ...
        db.send_create_signal('iwidget', ['Appliance'])

        # Adding field 'IWTimeseries.regular'
        db.add_column('iwidget_iwtimeseries', 'regular',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('iwidget_appliancetimeseries')

        # Deleting model 'SmartMeter'
        db.delete_table('iwidget_smartmeter')

        # Deleting model 'Appliance'
        db.delete_table('iwidget_appliance')

        # Deleting field 'IWTimeseries.regular'
        db.delete_column('iwidget_iwtimeseries', 'regular')
