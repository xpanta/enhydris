...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('iwidget_neighbour', (
        ...
        db.send_create_signal('iwidget', ['Neighbour'])

        # Adding unique constraint on 'Neighbour', fields ['household1', 'household2']
        db.create_unique('iwidget_neighbour', ['household1_id', 'household2_id'])

        # Adding model 'ApplianceOperation'
        db.create_table('iwidget_applianceoperation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('iwidget', ['ApplianceOperation'])


    def backwards(self, orm):
        # Removing unique constraint on 'Neighbour', fields ['household1', 'household2']
        db.delete_unique('iwidget_neighbour', ['household1_id', 'household2_id'])

        # Deleting model 'Neighbour'
        db.delete_table('iwidget_neighbour')

        # Deleting model 'ApplianceOperation'
        db.delete_table('iwidget_applianceoperation')
